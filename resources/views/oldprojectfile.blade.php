...
<div class="scroller">
  ...
  <div id="ourservices">
    <h1><span class="our">Our</span> SERVICES</h1>
  </div>
  ...
  <!-- =====================Satisfied Clients============================ -->
  <section id="clients">
    <!-- <img src = "./Contents/images/circle.png"> -->
  ...
  <div id="portfolio">
    <div class="container-fluid" style="padding: 0;">
      ...
      <section id="portfolio">
        <div class="container-fluid allprojects" id="mobappprojects">
          <div class="row portfolioimages">
            @if(@$projectsfirstsection)
                @foreach($projectsfirstsection as $project)
                    @php
                        $image3='';
                        $image4='';
                        $image5='';
  ...
  <section id="ourteam">
    ...
    <div class="container">
      <div class="row">
        <div class="carouselmember owl-carousel" style="display: block;">
          @if(@$team)
          ...
          <div class="members">
            ...
            <div class="membercount">
              <p>
                @if($teamember->id < 10) 0{{$teamember->id}} @else {{$teamember->id}} @endif </p>
  ...
  <script type="text/javascript">
    function changeBG(img) {
      ...
      // document.getElementById("overlayall").style.backgroundImage = "url('" +img+ "')";
    }

    function showDiv(img1, img2, img3, img4, title, color, content) {
        // $('#curtainleft').add('load',function() {
